...
7) To download WinDaq (to be released in July 10), please visit [run.dataq.com](https://run.dataq.com/). WinDaq is a proprietary commercial software from DATAQ, but allows free personal use only under this Arduino project
