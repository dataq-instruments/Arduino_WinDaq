...
7) To download WinDaq, please visit [run.dataq.com](https://run.dataq.com/). WinDaq is a proprietary commercial software from DATAQ, and it allows free personal home use only under this Arduino project
